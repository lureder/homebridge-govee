...
export default class GoveeIceMakerH8121 {
  constructor(platform, accessory) {
    ...
    // values. Unlike the H8120, this generation's BLE size byte runs in the SAME
  ...
  async internalStateUpdate(value) {
    try {
      ...
      if (value) {
        ...
        // and is pending confirmation from an owner of either model.
        await this.platform.sendDeviceUpdate(this.accessory, {
          cmd: 'ptReal',
