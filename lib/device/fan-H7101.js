    ...
    try {
      ...
      await this.platform.sendDeviceUpdate(this.accessory, {
        ...
        openApi: this.accessory.context.openApiCapabilities?.workMode
          ? { instance: 'workMode', capabilityType: 'devices.capabilities.work_mode', value: { workMode: 1, modeValue: value / 11 } }
          : undefined,
      })
    ...
    (params.commands || []).forEach((command) => {
      ...
      switch (deviceFunction) {
        case '0501': {
          ...
          const newSpeedInt = Number.parseInt(newSpeed, 16) * 11
