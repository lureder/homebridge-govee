 ...
 *
 * The frame carries it as two bytes of hundredths of a degree fahrenheit. That
 * layout has never been confirmed against a kettle sitting at a known
 * temperature, so the result is checked before it is used: a kettle holds
 * water, and a figure outside freezing to a little past boiling is not a
 * temperature at all - it means this model packs the frame differently.
 * Returning nothing then leaves the tile absent rather than wrong.
 *
