...
export default {
  ...
  deviceDiffuserBasic,
  deviceFanBasic,
  // The three ceiling fans all speak the same language - two lights on `aa 36`
  // and the fan on `aa 31` - settled by the captures on #1358. The H1370 was
  // on the base handler, which had those the other way round
  deviceFanH1310: deviceFanCeiling,
  deviceFanH1370: deviceFanCeiling,
  deviceFanR1310: deviceFanCeiling, // R1310 is the newer naming of the H1310
  deviceFanH7100,
