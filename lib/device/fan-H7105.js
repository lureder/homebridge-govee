...
export default class {
  constructor(platform, accessory) {
    ...
    // Remove oscillation (Swing) characteristic if present
    try {
      const swingChar = this.service.getCharacteristic(this.hapChar.SwingMode)
      if (swingChar) {
        this.service.removeCharacteristic(swingChar)
      }
    } catch (e) {
