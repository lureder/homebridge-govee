...
export function decodeH5074Values(streamUpdate) {
  ...
  const temp_lsb = [
    ...streamUpdate.substring(8, 10),
    ...streamUpdate.substring(6, 8),
  ]
  const hum_lsb = [
    ...streamUpdate.substring(12, 14),
    ...streamUpdate.substring(10, 12),
  ]
...
export function decodeH5179Values(streamUpdate) {
  ...
  const temp_lsb = [
    ...streamUpdate.substring(14, 16),
    ...streamUpdate.substring(16, 18),
  ]
  const hum_lsb = [
    ...streamUpdate.substring(18, 20),
    ...streamUpdate.substring(16, 18),
  ]
