...
// The commands Govee's local network api answers to
...
describe('what goes out over the local network', () => {
  ...
  it('says nothing at all for a command the local api has no form of', () => {
    // Better to leave it to the other connections than send something ignored
