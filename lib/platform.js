  ...
  async pluginSetup() {
    ...
    try {
      ...
      devicesInHB.forEach((accessory) => {
        // If the accessory doesn't exist in Govee then remove it. Also remove it
        // if it is now being ignored, or if it is a matter model and the user has
        // enabled ignoreMatter (otherwise the cached accessory lingers even though
        // the device is skipped during setup) (#1287).
        if (
