...
import { CMD } from './utils/ble-protocol.js'
...
export default class {
  ...
  async sendDeviceUpdate(accessory, params) {
    ...
    switch (params.cmd) {
      ...
      case 'stateOutlet': {
        const outletCaps = getDeviceCapabilities(accessory.context.gvModel)
        data.awsParams = {
          cmd: 'turn',
          data: { val: params.value === 'on' ? outletCaps.awsPowerOn : outletCaps.awsPowerOff },
        }
        data.openApiParams = {
          cmd: 'stateOutlet',
          value: params.value,
      ...
      case 'brightness': {
        ...
        */
        ...
        data.bleParams = {
          cmd: CMD.BRIGHTNESS,
          data: Math.floor(
            (params.value / 100) * getDeviceCapabilities(accessory.context.gvModel).bleBrightnessScale,
          ),
        }
        data.lanParams = {
          cmd: 'brightness',
      ...
      case 'color': {
        ...
        */
        ...
        const colorCaps = getDeviceCapabilities(accessory.context.gvModel)
        data.bleParams = {
          cmd: CMD.COLOR_MODE,
          data: [
            ...colorCaps.bleColorCmd,
            params.value.r,
            params.value.g,
            params.value.b,
            ...colorCaps.bleColorCmdSuffix,
          ],
        }
        data.lanParams = {
          cmd: 'colorwc',
      ...
      case 'colorTem': {
        ...
        */
        ...
        const ctCaps = getDeviceCapabilities(accessory.context.gvModel)
        data.bleParams = {
          cmd: CMD.COLOR_MODE,
          data: [
            ctCaps.bleColorCmd[0],
            0xFF,
            0xFF,
            0xFF,
            0x01,
  ...
  receiveDeviceUpdate(accessory, params) {
    ...
    */
    ...
    /*
      WORK MODE (OpenAPI - mode and speed for appliances)
    */
    ...
    /*
      TOGGLES (OpenAPI - nightlight, oscillation, lock, display, etc.)
    */
    ...
    /*
      TARGET TEMPERATURE (OpenAPI - heaters)
    */
    ...
    /*
      TARGET HUMIDITY (OpenAPI - humidifiers)
    */
    ...
    /*
      SENSOR TEMPERATURE (OpenAPI - property capability)
    */
    ...
    /*
      SENSOR HUMIDITY (OpenAPI - property capability)
    */
