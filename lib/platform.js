...
import { CMD, COLOR_SUB } from './utils/ble-protocol.js'
      ...
      case 'colorTem': {
        ...
        */
        ...
        data.bleParams = {
          cmd: CMD.COLOR_MODE,
          data: [
            platformConsts.bleColourD.includes(accessory.context.gvModel) ? COLOR_SUB.RGB_ALT : COLOR_SUB.RGB_DEFAULT,
            0xFF,
            0xFF,
            0xFF,
            0x01,
