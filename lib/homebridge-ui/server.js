...
// Models whose category does not say what the device actually is, so the
// picker would file them in the wrong config section without an override
const modelOverrides = {
  H5085: 'switchDevices', // dual smart plug, in the template category
}
...
class PluginUiServer extends HomebridgePluginUiServer {
  constructor() {
    ...
    this.onRequest('/getModelMap', () => {
      ...
      Object.assign(modelToArray, modelOverrides)
      return modelToArray
    })
